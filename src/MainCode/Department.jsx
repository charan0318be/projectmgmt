  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6 space-y-6">
      ...
      <div className="text-sm text-gray-500">
        Home &gt; <span className="text-gray-700 font-medium">Department</span>
      </div>
          ...
          <table className="min-w-full text-sm">
            <thead className="bg-gray-100 text-gray-700">
              <tr>
                ...
                <th className="p-3 border text-left">Parent Department</th>
      ...
      {!showForm && (
        <div className="text-sm text-gray-600 flex justify-between items-center mt-4">
          ...
          <div className="flex gap-2">
            ...
            <span className="px-3 py-1 border rounded bg-red-500 text-white">1</span>
